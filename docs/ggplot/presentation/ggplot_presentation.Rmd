...
keywords: r, RaukR, markdown, ggplot, graphics
output: 
...
.size-80[![](ggplot_presentation_assets/tidy.png)]
...
```{r,echo=TRUE,fig.height=1.2,fig.width=4.8}
...
.pull-right-60[
```{r,echo=TRUE,fig.height=3.8,fig.width=3.8}
x1 <- ggplot(iris) + 
...
```{r,fig.height=3.8,fig.width=9,echo=FALSE}
...
.pull-right-50[
```{r,fig.height=3.6,fig.width=4.5}
p + newtheme
```
]
