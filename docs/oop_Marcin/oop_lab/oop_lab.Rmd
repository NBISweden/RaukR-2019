...
* What is the class of a `tibble`? You have to load the `tidyverse` package and use one of the built-in datasets. e.g. `mtcars` as argument to `as_tibble()` to check the class.
...
* What would you improve our implementation of `protein`. Is it really user-friendly?
